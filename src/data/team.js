...
export const team = [
  { id: 'luka-strezoski', name: { sr: 'Лука Стрезоски', en: 'Luka Strezoski', de: 'Luka Strezoski', ru: 'Лука Стрезоски' }, title: 'проф. др', head: false, email: 'lukastrezoski@uns.ac.rs', ftnProfileUrl: 'https://ftn.uns.ac.rs/1927/luka-strezoski' },
  ...
  { id: 'darko-lazarevic', name: { sr: 'Дарко Лазаревић', en: 'Darko Lazarević', de: 'Darko Lazarević', ru: 'Дарко Лазаревич' }, title: 'асист.', head: false, email: 'darkolazarevic@uns.ac.rs', ftnProfileUrl: 'https://ftn.uns.ac.rs/2637/darko-lazarevic' },
